...
// Compile-time check: AssetRegistry satisfies the dual-write Registry. The
// async activation methods (MarkProjectionReady/Activate/ReconcileScan) are
// asserted in asset_activation.go against asset.ActivationRegistry.
