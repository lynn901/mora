...
const mockVersions: Record<string, DocumentVersion[]> = {
  d1: [
    ...
    },
    {
      ...
      version: 2,
      content:
        "# Introduction\n\nWelcome to the Mora platform.\n\n## Overview\n\nThis is a collaborative knowledge base.",
      contentFormat: "markdown",
      createdBy: "u1",
      createdAt: "2026-03-01T00:00:00Z",
      changeSummary: "Added overview section",
    },
    {
      id: "v3",
      documentId: "d1",
      version: 3,
      content: mockDocuments.n2!.content,
      contentFormat: "markdown",
      createdBy: "u2",
      createdAt: "2026-07-01T00:00:00Z",
      changeSummary: "Added code examples and diagram",
    },
  ],
}
...
const mockComments: Comment[] = [
  {
    ...
    documentId: "d1",
    blockId: "heading-1",
    content: "Should we add more examples?",
    createdBy: "u2",
    ...
    replies: [
      {
        ...
        documentId: "d1",
        blockId: "heading-1",
        content: "Good idea, I'll add some.",
        createdBy: "u1",
...
export async function apiSetPermission(
...
export async function apiDeletePermission(id: string): Promise<void> {
  ...
  if (index >= 0) mockPermissions.splice(index, 1)
}
...
export async function apiSearch(
  ...
  return results.filter((r) => {
    if (
      ...
      !r.snippet.toLowerCase().includes(filters.query.toLowerCase())
    )
      return false
    if (filters.workspaceId && r.workspaceId !== filters.workspaceId)
      return false
    return true
  })
}
...
export async function apiGetPresences(
  documentId: string
