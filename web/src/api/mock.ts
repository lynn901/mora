...
const mockDocuments: Record<string, Document> = {
  n2: {
    ...
    createdAt: "2026-01-01T00:00:00Z", updatedAt: "2026-07-01T00:00:00Z",
    tags: ["guide", "intro"], status: "published",
  },
  n3: {
  ...
  n5: {
    ...
    tags: ["architecture", "design"], status: "published",
  },
  n7: {
    ...
    tags: ["api", "rest"], status: "published",
  },
  n8: {
