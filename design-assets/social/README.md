...
| 文件 | 尺寸 | 用途 |
|---|---:|---|
| `story-01-announcement.svg` | `1080 × 1920` | 产品更新、活动公告 |
| `story-02-quote.svg` | `1080 × 1920` | 观点摘录、金句 |
| `story-03-digest.svg` | `1080 × 1920` | 周报、三条内容摘要 |
| `cover-01-editorial.svg` | `1080 × 1080` | 文章、观点封面 |
| `cover-02-report.svg` | `1080 × 1080` | 报告、研究封面 |
| `cover-03-ip.svg` | `1080 × 1080` | 品牌叙事、轻量内容封面 |
